'''ref: https://machinelearningmastery.com/how-to-develop-machine-learning-models-for-multivariate-multi-step-air-pollution-time-series-forecasting/'''
...
# load dataset
dataset = read_csv(str(Path.home() /'Data/Kaggle/TrainingData.csv'), header=0)
...
savetxt(str(Path.home()/'Outputs/naive_train.csv'), train_rows, delimiter=',')
savetxt(str(Path.home()/'Outputs/naive_test.csv'), test_rows, delimiter=',')
